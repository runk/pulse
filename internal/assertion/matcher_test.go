...
func TestStringListMatcher(t *testing.T) {
	scenarios := []struct {
		...
		{"contains fail", StringListMatcher{Contains: new("c")}, []string{"a", "b"}, "expected to have 'c' in the list ['a', 'b']"},
		{"contains empty list fail", StringListMatcher{Contains: new("a")}, []string{}, "expected to have 'a' in the list ['']"},
		...
		{"not contains fail", StringListMatcher{NotContains: new("a")}, []string{"a", "b"}, "expected not to have 'a' in the list ['a', 'b']"},
		...
		{"combined stops on contains fail", StringListMatcher{Contains: new("c"), Any: &StringMatcher{Equals: new("a")}}, []string{"a", "b"}, "expected to have 'c' in the list ['a', 'b']"},
